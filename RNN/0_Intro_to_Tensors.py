...
print(f"Reshape as row vector: {mat_tensor.reshape(1, -1)}")  # Reshape as row vector
print(f"Reshape as column vector: {mat_tensor.reshape(-1, 1)}")  # Reshape as column vector