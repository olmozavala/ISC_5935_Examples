...
class DenseModel(nn.Module):
    ...
    def __init__(self, hidden_layers=1, neurons_per_layer=1, activation_hidden='relu', activation_output='linear', batch_nomalization=False):
        ...
        self.bn = nn.BatchNorm1d(neurons_per_layer)
